    ...
    <div class="overflow-hidden px-6 py-4 relative">
        ...
        title="Update Category">
            <template v-slot:body>
                <router-link to="/admin/ecommerce/categorys" class="flex items-center justify-center bg-kakaPrimary dark:text-black100 py-2 px-8 w-full rounded-sm bor">
...
import { CategoryUpdateRequest } from '../../../../types/category';
...
let updatecategory: CategoryUpdateRequest= {
id:"",
title: "",
description: "",
icon: "",
...
export default defineComponent({
    ...
    setup(){
        ...
        const categorySubmit = () => {
            ...
            let ID =id.toString()
            state.form.id = ID
        new CategoryService().UpdateCategory(state.form).then((response:any)=>{
...
const getCategoryView = () => {
      ...
      new CategoryService().GetCategoryView(ID).then((response: any) => {
        ...
        return {
            ...toRefs(state),getBackendError, V1$, categorySubmit, fileInput,reset,selectImage,ImageList,iconUrl,selectBanner,bannerUrl,
