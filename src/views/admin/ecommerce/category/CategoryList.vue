                            ...
                            <div class="relative">
                                ...
                                <portal :to="data.id">
                                    <div :id="data.id" class="edit-drop z-30 fixed space-y-3 rounded shadow-lg p-4 w-max bg-white dark:bg-black100 text-base py-2">
                                        <router-link :to="{name:'category-view', params:{id:data.id} }" :data="data" class="flex items-center space-x-3">
                                        ...
                                        <router-link :to="{name:'category-update', params:{id:data.id} }" :data="data" class="flex items-center space-x-3">
