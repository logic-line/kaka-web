...
import { HijamaCreateRequest, HijamaListRequest } from '../../../types/hijama';
...
let createHijama: HijamaCreateRequest= {
        title: "",
        description: "",
        icon: "",
        banner: "",
...
export default defineComponent({
    ...
    setup(){
        ...
        new HijamaService().CreateHijama(state.form).then((response:any)=>{
...
const ImageList = ()=>{
    new ImageService().listOfImage().then((response:any)=>{
        ...
        return {
            ...toRefs(state),getBackendError, V1$, hijamaSubmit, fileInput,reset,
