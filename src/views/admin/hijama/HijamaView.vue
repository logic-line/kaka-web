<template>
  <div class="overflow-hidden px-6 py-4 relative">
   ...
   <div class="px-4 md:px-8 py-8 mb-10  dark:bg-secondary10 dark:text-white border border-gray-300 dark:border-gray-500">
      ...
      <div>
        <div class="">
          <p class="text-center uppercase font-semibold bg-gray-300 py-2">Hijama Details</p>
      </div>
          ...
          <div class="w-full">
            ...
            <div class="flex flex-wrap items-center justify-center">
              ...
              <div class="p-2">
                  ...
                  <p @click="removeHijamaImage(item.id)" class="w-full text-sm bg-red-500 text-white text-center cursor-pointer">Remove</p>
              </div>
            </div>
                             ...
                             <div class="px-4 py-4">
                                ...
                                <div class="w-full">
                                        <div class="flex items-center py-4 mb-2">
                                            <input v-model="hijamaimageform.url" name="url" class="modal-input-style" placeholder="URL">
                                            <img src="@/assets/images/star.svg" alt="image" class="w-2.5 ml-1">
                                        </div>
                                        <div class="text-red-500 mr-1">{{ getBackendError3('url') }}</div>
                                        <div v-if="V3$.hijamaimageform.url.$errors[0]" class="text-red-500">{{ V3$.hijamaimageform.url.$errors[0].$message }}</div>
                                </div>
                                <div class="w-full">
                                        <div class="flex items-center py-4 mb-2">
                                            <input v-model="hijamaimageform.title" name="title" class="modal-input-style" placeholder="TITLE">
                                            <img src="@/assets/images/star.svg" alt="image" class="w-2.5 ml-1">
                                        </div>
                                        <div class="text-red-500 mr-1">{{ getBackendError3('title') }}</div>
                                        <div v-if="V3$.hijamaimageform.title.$errors[0]" class="text-red-500">{{ V3$.hijamaimageform.title.$errors[0].$message }}</div>
                                </div>
                                <div class="w-full">
                                  <div class="flex items-center py-4 mb-2">
                                            <select v-model="hijamaimageform.enabled" name="enabled" class="modal-input-style py-3 mb-2">
                                  ...
                                  <div v-if="V3$.hijamaimageform.enabled.$errors[0]" class="text-red-500">{{ V3$.hijamaimageform.enabled.$errors[0].$message }}</div>
                              </div>
                               <div class="w-full">
                                  <textarea v-model="hijamaimageform.description" placeholder="DESCRIPTION" class="modal-input-style" id="description" name="description" rows="4" cols="50">
                                  </textarea> 
                              </div>
