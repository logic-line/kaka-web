    ...
    <div class="overflow-hidden px-6 py-4">
        ...
        <TableCompo id="tableContainer"> 
            <template v-slot:header>
                ...
                <table-title-column class="table-cell" name="reason"  ></table-title-column>
            ...
            <template v-slot:body>
                <tr v-for="data in tableData" :key="data.id" class="border dark:bg-black100 bg-secondary10">
                    ...
                    <table-data-comp :data="data.reason"></table-data-comp>
                            ...
                            <div class="relative">
                                ...
                                <portal :to="data.id">
                                    <div :id="data.id" class="edit-drop z-30 fixed space-y-3 rounded shadow-lg p-4 w-max bg-white dark:bg-black100 text-base py-2">
                                        <router-link :to="{name:'qurbani-booking-view', params:{id:data.id} }" :data="data" class="flex items-center space-x-3">
                                        ...
                                        <!-- <router-link :to="{name:'qurbani-update', params:{id:data.id} }" :data="data" class="flex items-center space-x-3">
...
import { QurbaniBookingListRequest } from '../../../types/qurbani';
...
let listFilterData : QurbaniBookingListRequest={
        perPage:10,
        page:1,
}
...
export default defineComponent({
    ...
    setup(){
       const { actionModalID, actionButton, positionEditDrop, toggleActionDropdown } = actionDropdown();
        ...
        const setTableData = ()=>{
            new QurbaniService().listOfBookingQurbani(state.filterForm).then((response:any)=>{
