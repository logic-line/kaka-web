    ...
    <div class="overflow-hidden px-6 py-4 relative">
        ...
        <div class="shadow-md bg-gray-50 dark:bg-secondary10 dark:text-white h-540 overflow-y-auto">
            <form @submit.prevent="qurbaniSubmit">
                ...
                <div class="mt-8 w-full flex flex-wrap items-center space-x-0 md:space-x-10 px-4">
                    <div class="py-2">
...
import { CreateQurbani } from '../../../types/qurbani';
...
let createQurbani: CreateQurbani= {
name:"",
description:"",
enabled:"",
icon:"",
...
const ImageList = ()=>{
        ...
        return {
            ...toRefs(state),getBackendError, V1$, qurbaniSubmit, fileInput,reset,
             selectImage,ImageList,iconUrl,selectBanner,bannerUrl,
