    ...
    <div class="overflow-hidden px-6 py-4">
        ...
        title="Update Location">
            <template v-slot:body>
                <router-link to="/admin/locations" class="flex items-center justify-center bg-kakaPrimary  text-white dark:text-black100 py-2.5 px-8 w-full rounded-sm bor">
     ...
     const getLocationView=()=>{
        ...
        return {
            ...toRefs(state),getBackendError, V1$, locationSubmit, fileInput,reset,
             ...
             closeIcon, closeBanner, handleMapClick
        }
    }
