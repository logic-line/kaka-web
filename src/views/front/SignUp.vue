  ...
  <div class="bg-white dark:bg-black">
    ...
    <main>
      <div class="flex items-center lg:custom-height-screen pt-36  pb-6 lg:pb-0">
        <form
          @submit.prevent="createUserRegister"
        ...
        >
          ...
          <div class="mt-7 flex flex-wrap -mx-4">
            ...
            <div class="lg:w-1/2 w-full px-4 mt-3">
              <div class="">
                ...
                />
                <div
                  v-if="V1$.form.mobilecode.$errors[0]"
                  class="text-warning block mt-1"
                >
                  {{ V1$.form.mobilecode.$errors[0].$message }}
                </div>
                <div class="text-red-500 mr-1">
                  {{ getBackendError("mobilecode") }}
                </div>
              </div>
            </div>
            ...
            <div class="lg:w-1/2 w-full px-4 mt-3">
              <div class="">
                ...
                />
                <div
                  v-if="V1$.form.mobilenumber.$errors[0]"
                  class="text-warning block mt-1"
                >
                  {{ V1$.form.mobilenumber.$errors[0].$message }}
                </div>
                <div class="text-red-500 mr-1">
                  {{ getBackendError("mobilenumber") }}
                </div>
              </div>
            </div>
            ...
            <div class="lg:w-1/2 w-full px-4 mt-3">
              <div class="relative">
                ...
                <div class="relative">
                  ...
                  />
                  <button
                    v-if="passwordData.confirmPassNotEye"
                    @click="showPass($event.target)"
                    class="see-pass absolute right-3 top-1/2 transform -translate-y-1/2"
                    type="button"
                  >
                    <svg
                      class="w-5 h-5 pointer-events-none"
                  ...
                  <button
                    v-if="passwordData.confirmPassEye"
                    @click="hidepass($event.target)"
                    class="hide-pass absolute right-3 top-1/2 transform -translate-y-1/2"
                    type="button"
                  >
                ...
                <div
                  v-if="V1$.form.confirmpassword.$errors[0]"
                  class="text-warning block mt-1"
                >
                  {{ V1$.form.confirmpassword.$errors[0].$message }}
                </div>
                <div class="text-red-500 mr-1">
                  {{ getBackendError("confirmpassword") }}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mt-7">
            <button
              type="submit"
              class="font-medium bg-kakaPrimary w-full py-2.5 rounded-sm hover:bg-black90 hover:text-white duration-300"
            >
              {{ $t("message.sign-up") }}
            </button>
          </div>
