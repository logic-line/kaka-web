<template>
     <div class="flex justify-center">
            <div class="relative">
                <button @click="toggleActionDropdown" type="button">
                ...
                <div v-show="actionModalID && actionModalID == modalId" class="right-0 rounded shadow-lg p-4 w-max -mx-2 absolute bg-white text-base z-50 float-left py-2">
                    <button  class="block">
